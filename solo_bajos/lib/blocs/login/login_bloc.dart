...
import 'package:solo_bajos/rest/rest_client.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  LoginBloc(AuthenticationBloc authenticationBloc,
      ...
      : assert(authenticationBloc != null),
        ...
        super(LoginInitial()) {
    on<LoginInWithUsernameButtonPressed>(__onLogingInWithUsernameButtonPressed);
  }

  __onLogingInWithUsernameButtonPressed(
